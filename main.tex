...
Let us use a simple game to motivate what changes in two dimensions.
...
There is of course the issue of a single exchange yielding a nontrivial operator squaring to one,
which does not alter any physically measurable value,
but what good is a nonmeasurable degree of freedom?
In all seriousness, I have no idea how to eliminate this case in a foolproof manner,
but various chatbots informed me that those internal degrees of freedom
can be dealt with as additional labels to either bosons or fermions.
\hwnote{Huh?}
}
...
should then be a phase factor $e^{i\theta}$.\footnote{%
Again, the unmeasurable degree of freedom issue appears here...
\hwnote{Help!}
}
